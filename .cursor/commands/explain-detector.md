...
3. Assumptions (camera model, marker dictionary, units).

Use code citations when pointing at specific lines. Do not change code unless the user asks for a fix or refactor.
